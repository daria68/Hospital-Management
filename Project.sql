...
-- 12. Crea?i tabelul audit_ddm cu urmatoarele câmpuri:
...
-- Defini?i un declan?ator care sa introduca date în acest tabel dupa ce utilizatorul a folosit o comanda LDD
-- (declan?ator sistem - la nivel de schema). (exercitiu preluat din laboratorul 6)
